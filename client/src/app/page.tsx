"use client"
import { MessageCircle, Droplet, Bell, Search, ArrowRight, Heart, Shield, Clock } from 'lucide-react';
      ...
      <section className="relative overflow-hidden pt-20 pb-16 md:pt-32 md:pb-24">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              <motion.button 
                className="px-6 py-3 bg-primary text-primary-foreground rounded-lg font-medium flex items-center justify-center gap-2 hover:opacity-90 transition-all"
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold">24/7 Medical Assistance Powered by AI</h2>
              <p className="mt-6 text-muted-foreground text-lg">
                Get immediate medical advice, symptom assessment, and early disease detection from our advanced AI system. Umeed is always available to provide guidance when you need it most.
              </p>
              <motion.div 
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Detailed assessment of your health concerns</p>
                  </div>
                </motion.div>
                <motion.div 
                  className="flex items-start"
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Identify potential health issues before they worsen</p>
                  </div>
                </motion.div>
                <motion.div 
                  className="flex items-start"
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Get medical assistance anytime, anywhere</p>
                  </div>
                </motion.div>
                <motion.div 
                  className="flex items-start"
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Advice tailored to your medical history</p>
                  </div>
                </motion.div>
              </motion.div>
              <motion.button 
                className="mt-8 px-6 py-3 bg-primary text-foreground rounded-lg font-medium self-start flex items-center gap-2"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              >
                ...
                <div className="space-y-4 mb-4">
                  ...
                  >
                    <p className="text-sm">I understand. Let me help you assess your symptoms. How severe is your headache on a scale of 1-10?</p>
                  </motion.div>
                  <motion.div 
                    className="bg-muted p-3 rounded-lg rounded-tl-none max-w-xs"
                    initial={{ opacity: 0, x: -20 }}
        ...
        <div className="container mx-auto px-4">
          ...
          >
                ...
                <div className="space-y-6">
                  ...
                  >
                    <div className="flex justify-between items-center mb-3">
                      ...
                      <span className="px-2 py-1 bg-chart-5/10 text-chart-5 text-xs rounded-full">B+</span>
                    </div>
                    <p className="text-sm">Need 2 units of B+ blood at City Hospital for emergency surgery. Location: North Wing, 3rd Floor.</p>
                  ...
                  >
                    <div className="flex justify-between items-center mb-3">
                      ...
                      <span className="px-2 py-1 bg-chart-1/10 text-chart-1 text-xs rounded-full">A-</span>
                    </div>
                    <p className="text-sm">Blood donation drive at Community Center on Saturday. Need A- donors for leukemia patients.</p>
                    <div className="mt-3 flex items-center justify-between">
                      <span className="text-xs text-muted-foreground">4.8 km away</span>
                      <motion.button 
                        className="px-3 py-1 bg-primary/10 text-primary text-sm rounded-full hover:bg-primary hover:text-primary-foreground transition-colors"
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                  ...
                  >
                    <div className="flex justify-between items-center mb-3">
                      ...
                      <span className="px-2 py-1 bg-chart-4/10 text-chart-4 text-xs rounded-full">O+</span>
                    </div>
                    <p className="text-sm">Required 1 unit O+ blood for surgery at Memorial Hospital. Thank you to all donors!</p>
                    <div className="mt-3 flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-xs text-muted-foreground">3 donors helped</span>
                      </div>
                    </div>
                  </motion.div>
                </div>
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold">Blood Bridge: Connecting Lives</h2>
              <p className="mt-6 text-muted-foreground text-lg">
                Our innovative platform connects blood donors with those in urgent need. Post requests, get notified about nearby donation opportunities, and save lives together.
              </p>
              <motion.div 
                className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Get notified about nearby donation requests</p>
                  </div>
                </motion.div>
                <motion.div 
                  className="flex items-start"
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Automatic matching with compatible donors</p>
                  </div>
                </motion.div>
              </motion.div>
              <motion.div 
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="mt-4 text-muted-foreground">Join thousands of users already benefiting from Umeed</p>
          </motion.div>
          <motion.div 
          ...
          >
            ...
            >
              <motion.p 
                className="text-4xl font-bold text-chart-1"
                initial={{ opacity: 0, scale: 0.5 }}
                whileInView={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.5, delay: 0.2 }}
                viewport={{ once: true, margin: "-100px" }}
