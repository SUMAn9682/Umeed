          ...
          <div className="space-y-8 text-lg">
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="text-card-foreground">
                  Umeed is a project designed to connect blood donors with those
                  in need during critical situations. Our platform sends
                  real-time email notifications to registered donors when blood
                  is urgently required, creating a bridge between donors and
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="text-card-foreground">
                  At the heart of our platform is Umeed, our AI chatbot that
                  assists users with information about blood donation,
                  compatibility, and answering common questions. Currently,
                  we&apos;re using the Grock model to power Umeed, but we have plans
                  to develop our own AI model in the future to better serve our
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="text-card-foreground">
                  Our mission is simple: to save lives by making blood donation
                  more accessible and efficient. By connecting donors directly
                  with those in need, we hope to reduce response times and
                  increase successful donations across communities.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="text-card-foreground">
                  ...
                  serve more communities and save more lives.
                </p>
              </div>
            </div>
          </div>
